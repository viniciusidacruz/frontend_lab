...
export const DetailsDemo = () => {
  return (
    <>
      ...
      <Document.Paragraph>
        Clique nos itens abaixo para expandir/recolher. Note que os dois
        últimos usam o atributo <Document.Code>name</Document.Code> para
        funcionar como accordion (apenas um aberto por vez).
      </Document.Paragraph>
      ...
      <div className="space-y-3 max-w-2xl">
        <details className="border border-zinc-700 rounded-lg p-4 bg-zinc-800/50">
          <summary className="cursor-pointer font-semibold text-zinc-100 list-none flex items-center gap-2">
            <span className="transition-transform duration-200 details-marker">▶</span>
        ...
        <Document.Paragraph>
          <strong className="text-zinc-300">Accordion com atributo name:</strong>
        </Document.Paragraph>
